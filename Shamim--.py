...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : SHAMIM HOSSEN                \033[94m│".center(columns+14))
    print("│ \033[95mTool   : Hack With Link                \033[94m│".center(columns+8))
    print("│ \033[95mGitHub : https://github.com/SHAMIM-CYBEE\033[94m│".center(columns+8))
    print("│ \033[95mCoder  : TERMUX HACKER SHAMIM             \033[37mV2.0  \033[94m│".center(columns+14))
    print("\033[94m└────────────────────────────────────────┘".center(columns+4))
